...
module.exports = ({ req }) => {
  return layout({
    content: `<header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        <!-- Masthead Avatar Image-->
        <img
          class="masthead-avatar mb-5 myImage"
          src="assets/img/portfolio/manish.jpg"
          alt="..."
        />
        <!-- Masthead Heading-->
        <h1 class="masthead-heading text-uppercase mb-0">Chhetri Rocks</h1>
        <!-- Icon Divider-->
